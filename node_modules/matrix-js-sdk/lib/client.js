...
export class MatrixClient extends TypedEventEmitter {
  ...
  unstableCreateFileTree(name) {
    ...
    return _asyncToGenerator(function* () {
      ...
      return new MSC3089TreeSpace(_this66, roomId);
    })();
  }
  ...
  getRoomSummary(roomIdOrAlias, via) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        ...
        return yield _this67.http.authedRequest(Method.Get, path, {
          via
        }, undefined, paramOpts);
      } catch (e) {
        if (e instanceof MatrixError && e.errcode === "M_UNRECOGNIZED") {
          ...
          return yield _this67.http.authedRequest(Method.Get, _path, {
            via
          }, undefined, paramOpts);
        } else {
          throw e;
  ...
  whoami() {
    var _this68 = this;
    return _asyncToGenerator(function* () {
      return _this68.http.authedRequest(Method.Get, "/account/whoami");
    })();
  }
  ...
  timestampToEvent(roomId, timestamp, dir) {
    ...
    return _asyncToGenerator(function* () {
      ...
      try {
        return yield _this69.http.authedRequest(Method.Get, path, queryParams, undefined, {
          prefix: ClientPrefix.V1
        });
      } catch (err) {
  ...
  getAuthIssuer() {
    var _this70 = this;
    return _asyncToGenerator(function* () {
      return _this70.http.request(Method.Get, "/auth_issuer", undefined, undefined, {
  ...
  getAuthMetadata() {
    ...
    return _asyncToGenerator(function* () {
      var authMetadata;
      try {
        authMetadata = yield _this71.http.request(Method.Get, "/auth_metadata", undefined, undefined, {
          prefix: ClientPrefix.Unstable + "/org.matrix.msc2965"
        });
      } catch (e) {
        if (e instanceof MatrixError && e.errcode === "M_UNRECOGNIZED") {
