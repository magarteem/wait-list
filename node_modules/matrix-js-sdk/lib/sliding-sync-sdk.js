...
import { SyncState, _createAndReEmitRoom, defaultClientOpts, defaultSyncApiOpts, mapToDeviceEvent } from "./sync.js";
...
class ExtensionToDevice {
  ...
  onResponse(data) {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (events.length > 0 && _this4.cryptoCallbacks) {
        events = yield _this4.cryptoCallbacks.preprocessToDeviceMessages(events);
      }
      events.map(mapToDeviceEvent).map(toDeviceEvent => {
        ...
        _this4.client.emit(ClientEvent.ToDeviceEvent, toDeviceEvent);
      });
    ...
    switch (state) {
      ...
      case SlidingSyncState.RequestFinished:
        if (err) {
          ...
          this.failCount = 0;
          logger.log("SlidingSyncState.RequestFinished with ".concat(Object.keys((resp === null || resp === void 0 ? void 0 : resp.rooms) || []).length, " rooms"));
        }
        break;
    }
  }
