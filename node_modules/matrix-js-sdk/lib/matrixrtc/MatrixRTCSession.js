...
export class MatrixRTCSession extends TypedEventEmitter {
  ...
  constructor(client, roomSubset, memberships) {
    ...
    _defineProperty(this, "recalculateSessionMembers", () => {
      ...
      if (changed) {
        ...
        logger.info("Memberships for call in room ".concat(this.roomSubset.roomId, " have changed: emitting"));
    ...
    this.setExpiryTimer();
    this.encryptionManager = new EncryptionManager(this.client, this.roomSubset, () => this.memberships, (keyBin, encryptionKeyIndex, participantId) => {
  ...
  joinRoomSession(fociPreferred, fociActive, joinConfig) {
    if (this.isJoined()) {
      logger.info("Already joined to session in room ".concat(this.roomSubset.roomId, ": ignoring join call"));
      return;
    } else {
      ...
      if ((_joinConfig$useNewMem = joinConfig === null || joinConfig === void 0 ? void 0 : joinConfig.useNewMembershipManager) !== null && _joinConfig$useNewMem !== void 0 ? _joinConfig$useNewMem : false) {
        this.membershipManager = new MembershipManager(joinConfig, this.roomSubset, this.client, () => this.getOldestMembership());
      } else {
  ...
  leaveRoomSession() {
    ...
    return _asyncToGenerator(function* () {
      ...
      if (!_this2.isJoined()) {
        logger.info("Not joined to session in room ".concat(_this2.roomSubset.roomId, ": ignoring leave call"));
        return false;
      }
      logger.info("Leaving call session in room ".concat(_this2.roomSubset.roomId));
  ...
  getEncryptionKeys() {
    ...
    var keys = (_this$encryptionManag = this.encryptionManager.getEncryptionKeys()) !== null && _this$encryptionManag !== void 0 ? _this$encryptionManag : new Map();
